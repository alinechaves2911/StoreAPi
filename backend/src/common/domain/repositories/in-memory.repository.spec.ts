...
describe('InMemoryRepository unit tests', () => {
  ...
  describe('applyFilter', () => {
    it('should no filter when filter parameter is null', async () => {
        const items = [model]
        const spyFilterMethod = jest.spyOn(items, 'filter' as any)
        const result = await sut['applyFilter'](items, null)
        //espera que  o filtro não seja chamado
  ...
  describe('search', () => {
    ...
    it('should appy paginate and filter', async () => {
    const items = [
        { id: randomUUID(), name: 'test', price: 10, created_at, updated_at },
        { id: randomUUID(), name: 'a',    price: 20, created_at, updated_at },
        { id: randomUUID(), name: 'TEST', price: 30, created_at, updated_at },
        { id: randomUUID(), name: 'TeSt', price: 40, created_at, updated_at },
    ]
    sut.items= items
      const result = await sut.search({
        page:1,
    ...
    it('should appy paginate and sort', async () => {
    const items = [
        { id: randomUUID(), name: 'b', price: 10, created_at, updated_at },
        { id: randomUUID(), name: 'a', price: 20, created_at, updated_at },
        { id: randomUUID(), name: 'd', price: 30, created_at, updated_at },
        { id: randomUUID(), name: 'e', price: 40, created_at, updated_at },
        { id: randomUUID(), name: 'c', price: 50, created_at, updated_at },
    ]
    sut.items= items
    ...
    it('should search using filter, sort and paginete', async () => {
    const items = [
        { id: randomUUID(), name: 'TEST', price: 10, created_at, updated_at },
        { id: randomUUID(), name: 'a', price: 20, created_at, updated_at },
        { id: randomUUID(), name: 'test', price: 30, created_at, updated_at },
        { id: randomUUID(), name: 'e', price: 40, created_at, updated_at },
        { id: randomUUID(), name: 'TeSt', price: 50, created_at, updated_at },
    ]
    sut.items= items
      let result = await sut.search({
        page:1,
